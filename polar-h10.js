...
// Classic UMD script (not an ES module) so it works in every context the app
// runs in — including file:// where ES-module imports are blocked by CORS.
// Exposes window.PolarH10 (and module.exports for Node/tests).
(function (global) {
'use strict';
...
class PolarH10 {
  ...
  global.PolarH10 = PolarH10;
  if (typeof module !== 'undefined' && module.exports) module.exports = { PolarH10 };
